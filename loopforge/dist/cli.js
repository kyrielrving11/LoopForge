...
async function cmdRun(_engine, jsonArg) {
    ...
    if (!raw.trim())
        die("run requires JSON input (argument or stdin)");
    const data = parseJson(raw);
