...
function init(args) {
    ...
    process.stdout.write("Start the server with:\n" +
...
export function main(argv = process.argv.slice(2)) {
    ...
    if (command === "mcp") {
        ...
        try {
            ...
            if (error.code === POLICY_INVALID_CODE) {
                process.stderr.write(`${POLICY_INVALID_CODE}: ${error.message}\n` +
