...
export function persistedFrontier(entries) {
    for (const entry of entries) {
        if (!isRecord(entry) || entry.task_type !== "session_state")
            continue;
