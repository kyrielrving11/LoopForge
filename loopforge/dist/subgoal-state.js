...
export function deriveSubGoalId(loopId, declaredAtRound, ordinal, description) {
...
export function deriveEmergedItems(loopId, declaredAtRound, descriptions) {
    const items = [];
    const seen = new Set();
    for (const raw of descriptions) {
        const normalized = normalizeDescription(raw);
