...
export function handle(
  requestInput: string | Record<string, unknown> | LoopForgeRequest,
  engine?: LoopForgeEngine,
): string {
  // Parse request
  let rawMode: string;
  let rawData: Record<string, unknown> | null = null;
  let request: LoopForgeRequest;
  ...
  if (rawData !== null) {
    ...
    request = requestInput as unknown as LoopForgeRequest;
  }
...
function isLoopForgeRequest(
  obj: unknown,
): obj is LoopForgeRequest {
  return (
    typeof obj === "object" &&
    obj !== null &&
    "mode" in obj &&
...
function parseRequest(
  ...
  const req: LoopForgeRequest = {
    ...
    feedback: (base.feedback as LoopForgeRequest["feedback"]) ?? null,
...
function compactHealth(engine: LoopForgeEngine): string {
