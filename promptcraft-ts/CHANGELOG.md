...
Initial TypeScript reference implementation of the PromptCraft protocol v3.5.
...
### CLI
- `promptcraft init` — initialise vault
- `promptcraft compile` — loop_compile mode (L0/L1/L2)
- `promptcraft feedback` — execution recording with quality scoring
- `promptcraft replay` — loop timeline with technique/quality history
- `promptcraft diff` — field-level round comparison
- `promptcraft review` — structural prompt audit
