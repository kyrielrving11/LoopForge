 ...
 */
import { type PromptCraftRequest } from "./protocol.js";
import { PromptCraftEngine } from "./engine.js";
export declare function handle(requestInput: string | Record<string, unknown> | PromptCraftRequest, engine?: PromptCraftEngine): string;
